...
Future<Map<String, dynamic>> fetchData(String url) async {
  final response = await http.get("$host/api/$url");
...
Future<Map<String, dynamic>> fetchDataWithAuth(String url, String token) async {
  final response = await http.get("$host/api/$url", headers: {
...
Future<Token> getToken(Object data) async {
  final response = await http.post("$host/api/login/access-token", body: data);
...
Future<bool> addQuestion(Object question) async {
  final response = await http.post("$host/api/questions/add", body: json.encode(question));
...
Future<bool> addAnswer(String qId, Object answer) async {
  final response = await http.post("$host/api/questions/$qId/answers/add", body: json.encode(answer));
