...
class QuestionPage extends StatefulWidget {
  ...
  QuestionPage({Key key, @required this.author, @required this.qId}) : super(key: key);

  @override
  createState() => _QuestionPageState(this.qId, this.author);
  ...
  loadData() async {
    ...
    if (this.mounted) {
      setState(() {
        ...
        this.itemList.add(question);
        this.itemList.addAll(answerList);
